...
- [x] Tests (AC: 1–3)
  ...
  - [x] Backend: integration test for `POST /api/v1/coffees` happy path and validation errors. [Source: docs/architecture/development-workflow.md#api-integration-testing]
